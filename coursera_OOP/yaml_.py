...
def constuctor_easy_level_class(loader, node):
    value = loader.construct_mapping(node)

    return {'map': EasyLevel.Map(), 'obj': EasyLevel.Objects()}

def constuctor_medium_level_class(loader, node):
    value = loader.construct_mapping(node)
    _obj = MediumLevel.Objects()
    _obj.config = value
    return {'map': MediumLevel.Map(), 'obj': _obj}

def constuctor_hard_level_class(loader, node):
    value = loader.construct_mapping(node)
...
yaml.add_constructor('!easy_level', constuctor_easy_level_class)
yaml.add_constructor('!medium_level', constuctor_medium_level_class)
yaml.add_constructor('!hard_level', constuctor_hard_level_class)
